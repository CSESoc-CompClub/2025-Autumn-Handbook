...
- [New Game](new_game/new_game.md)
    ...
    - [Task 3: OTHER ASSETS](new_game/other_assets.md)
        ...
        - [Task 3.3: Initialise Active Foods List](new_game/initialise_active_foods.md)
        - [Task 3.4: Create Food Draw Method](new_game/food_draw_method.md)
        - [Task 3.5: Draw Active Foods in Game Loop](new_game/draw_active_foods.md)
